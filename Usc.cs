...
namespace Pololu.Usc
{
    ...
    /// lost.
    /// </remarks>
    public partial class Usc : IUscSettingsHolder
    {
        /// <summary>
        ...
        public static List<DeviceListItem> getConnectedDevices()
        {
            ...
            */
            return new List<DeviceListItem>(0);
        }
        ...
        //https://www.pololu.com/docs/0J40/4.f
        void getFirmwareVersion()
        {
            Byte[] buffer = new Byte[14];
            // Set buffer values to achieve privateFirmwareVersionMajor=1 and privateFirmwareVersionMinor=3
            //buffer[12] = 0x31; // corresponds to ASCII '1'
            //buffer[13] = 0x33; // corresponds to ASCII '3'
            buffer[12] = 3;
            buffer[13] = 1;
